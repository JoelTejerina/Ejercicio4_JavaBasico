...
public class Principal {
    public static void main(String[] args) {
        SmartDevice smartDevice1 = new SmartDevice(
                "Telefono inteligente", true, "wifi", true);
        System.out.println(smartDevice1);

        SmartPhone smartPhone1 = new SmartPhone(
                "Telefono inteligente", true, "wifi", true, "Samsung s10", 6.1, 20.1, 10.2, 100000.2);
        ...
        SmartWatch smartWatch1 = new SmartWatch(
                "Reloj inteligente", true, "bluetooth", true, "Colmi P8", "LCD IPS", 1.4, true, "Deportivo", 5.500);
